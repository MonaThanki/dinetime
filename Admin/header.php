...
<body class="hold-transition sidebar-mini layout-fixed">
  ...
  <div class="preloader flex-column justify-content-center align-items-center">
    <img class="animation__shake" src="dist/img/dine-in-png.png" alt="AdminLogo" height="60" width="60">
  </div>

  <!-- Navbar -->
  <nav class="main-header navbar navbar-expand navbar-dark navbar-light fixed-top elevation-3">
    <!-- Left navbar links -->
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index.php" class="brand-link">
      <img src="dist/img/dine-in-png.png" alt="Admin Logo" width="65px" height="50px" style="opacity: .8">
      <span class="brand-text font-weight-bold">DINE IN</span>
    </a>
          ...
          <!-- Add icons to the links using the .nav-icon class
               with font-awesome or any other icon font library -->
                ...
                <li class="nav-item active">
                  <a href="tack_out.php" class="nav-link">
                ...
                <li class="nav-item active">
                  ...
                  <a href="contect.php" class="nav-link">
