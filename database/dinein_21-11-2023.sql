...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 21, 2023 at 10:52 AM
...
(88, 101, 'kjjkb', 'kjnjk@sdfs.com', '3333333333', '2023-11-28', 1),
(89, 102, 'sdfjb skdjb', 'sfd@drsgfk.com', '3444444444', '2023-11-21', 1),
(90, 103, 'Mona Thanki', 'mona@gmail.com', '2222222222', '2023-11-27', 3),
(91, 104, 'mona thanki', 'mona@gmail.com', '1111111111', '2023-12-06', 1),
(92, 105, 'bipin patel', 'bipin@gmail.com', '1111111111', '2023-12-07', 3);
...
(0, 'mona`', 'mona@gmail.com', 'test', 'test');
...
(8, 'user', 'user', 'user@gmail.com', 2147483647, 'user123', 'user123');
...
--
ALTER TABLE `cart`
  ADD CONSTRAINT `cart_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `userregister` (`u_id`),
  ADD CONSTRAINT `cart_ibfk_2` FOREIGN KEY (`product_id`) REFERENCES `menu` (`MID`);
